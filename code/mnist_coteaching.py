...
for epoch in range(0, n_epoch):
    ...
    print('Epoch [%d/%d] Test Accuracy on the %s test images: Model1 %.4f %% Model2 %.4f %%' % (epoch, n_epoch, len(test_dataset), test_acc1, test_acc2))

torch.save(cnn1, "data/nn_mnist_coteach1_50epoch.pt")
torch.save(cnn2, "data/nn_mnist_coteach2_50epoch.pt")
np.savetxt("data/train_loss_mnist_coteach_50epoch.csv", train_loss)
np.savetxt("data/test_acc_mnist_coteach1_50epoch.csv", test_accs_1)    
np.savetxt("data/test_acc_mnist_coteach2_50epoch.csv", test_accs_2)    
