                        ...
                        "TRI_FLAG", "GHG_FLAG", "FAC_IMP_WATER_FLG","EJSCREEN_FLAG_US", "multiple_IDs","n_IDs",\
                                "SIC_AG_f", "SIC_MINE_f", "SIC_CONS_f", "SIC_MANU_f", "SIC_UTIL_f",\
                                    "SIC_WHOL_f", "SIC_RETA_f", "SIC_FINA_f", "SIC_SERV_f", "SIC_PUBL_f",\
                                        "num.facilities.cty", "num.facilities.st", "Party", "PERMIT_MAJOR",\
                                        "PERMIT_MINOR"]
    random_full_x = random_full[x_names]
    np.shape(random_full_x)[0]
    undup_x = random_full_x.drop_duplicates()
    np.shape(undup_x)[0]

    EJ_Y = random_full_x[random_full_x['EJSCREEN_FLAG_US'] == 'Y']
    np.shape(EJ_Y)[0]
    undup_EJ_x = EJ_Y.drop_duplicates()
    np.shape(undup_EJ_x)[0]
